...
(defun kwarks--tree-node-set-face (node is-directory is-link)
  (cond (is-directory (propertize node 'font-lock-face 'kwarks/tree-directory-face))
        (is-link (propertize node 'font-lock-face 'kwarks/tree-link-face))
      ...
      (if is-root
        ...
        (insert
         (propertize (format "%s%s %s" spacing prefix
                             (kwarks--tree-node-set-face name is-directory is-link))
                     'kbd-help full-name)))
