...
;; looks like it's already been initialized somewhere else    
;;    (package-initialize)
...
[M-p] preview in Emacs
[M-P] external preview
...
- Download and install [[https://ollama.com][Ollama]]
- Install default model and codellama
...
Ellama commands:
- /ellama-chat/ Ask Ellama about something by entering a prompt in an interactive buffer and continue conversation.
...
- /ellama-code-add/ Add new code according to a description, generating it with a provided context from the selected region or the current buffer using Ellama.
...
- /ellama-solve-reasoning-problem/ Solve reasoning problem with Absctraction of Thought technique.
- /ellama-solve-domain-specific-problem/ Solve domain specific problem with simple chain.
...
Set scheme mode for microscheme
#+begin_src emacs-lisp :tangle yes
...
** python
Install python via [[https://github.com/pyenv/pyenv/][pyenv]]!
