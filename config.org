...
(defun apply-custom-theme (&rest args)
  (interactive)
  ...
  ;; override modeline theme settings
  (custom-set-faces
   `(region                   ((t (:foreground nil        :background "#376da4")))) ; selection color
   `(hl-line                  ((t (:foreground nil        :background "#333333"))))
   `(trailing-whitespace      ((t (:foreground "gray"     :background "gray"))))
   `(mode-line                ((t (:foreground "gray"     :background nil :box nil))))
   `(mode-line-inactive       ((t (:foreground "SkyBlue4" :background nil :box nil))))
  ...
  (add-to-list 'default-frame-alist '(cursor-color . "#C2C8D3"))
  (add-to-list 'default-frame-alist '(mouse-color . "white"))

  ;; override some font settings
  (set-face-italic 'font-lock-comment-face t)
  (set-face-italic 'org-block-begin-line t)
  (set-face-italic 'org-block-end-line t)

  ;; override org mode styles
  (setq org-ellipsis "…")
...
(use-package doom-themes
  ...
  :init
  (advice-add #'load-theme :after #'apply-custom-theme)
