...
;; Frame geometry is restored by desktop-restore-frames below.  It maps the
;; saved character dimensions accurately because early-init.el already gave
;; the frame its final font (see theme-cache.el); and frame-inhibit-implied-
;; resize keeps later font/modeline changes from shrinking it.  No extra
;; geometry handling is needed.
